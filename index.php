...
<div class="w-full h-16 px-10 flex justify-between items-center">
  ...
  <ul class="flex gap-4 items-center">
    ...
    <button id="dropdownButton" class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
      Pilih Kategori
    </button>
